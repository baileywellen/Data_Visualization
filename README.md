...
4. [Perform calculations in Tableau: Calculate fields and create functions in Tableau](./Class_Objectives.md#obj_1)    
5. [Work with tables in Tableau: Be able to create and process table calculations in Tableau](./Class_Objectives.md#obj_1)      
6. [Create maps in Tableau: Use Tableau to do basic geospatial analysis.](./Class_Objectives.md#obj_1)     
7. [Mapping with ArcGIS online: Use the online version of ESRI's ArcGIS for basic geospatial processing.](./Class_Objectives.md#obj_1)       
